...
5. **알림 클릭 시**: 알람 자동 완료 처리 (isActive → false)
6. **완료 버튼 클릭**: 앱을 열지 않고도 알람 완료 (Android)
...
### 알림 상호작용
**알림 클릭**:
- 알림을 탭하면 해당 알람이 자동으로 완료 처리됩니다
- Firestore에서 isActive가 false로 변경됩니다
- 더 이상 같은 알람이 울리지 않습니다

**완료 버튼 (Android)**:
- 알림창에 "완료" 버튼이 표시됩니다
- 앱을 열지 않고도 알람을 즉시 완료할 수 있습니다
- 버튼을 누르면 알림이 사라지고 알람이 비활성화됩니다

**iOS**:
- 알림을 탭하면 알람이 자동으로 완료됩니다
- (액션 버튼은 네이티브 코드 추가 필요)
